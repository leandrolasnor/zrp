...
class Grpc::CreateThreat::Listeners::Dashboard::Widgets::BattlesLineup::Job
  include Dry.Types()
  extend Dry::Initializer

  option :monad, type: Interface(:call), default: -> { Dashboard::Widgets::BattlesLineup::Monad.new }, reader: :private
